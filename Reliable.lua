...
local function runMainScript()
    ...
    local Games = loadstring(game:HttpGet('https://raw.githubusercontent.com/ILoveScripting680/SlapBattlesHub/refs/heads/main/SlapBattlesHub/THE-SUPER-HUB-THAT-EXISTS/SlapBattlesHub'))()
